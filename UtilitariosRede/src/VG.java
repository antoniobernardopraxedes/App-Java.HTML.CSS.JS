...
// Nome da Classe: VG                                                                                             *
//                                                                                                                *
// Funcao: Contém as Variáveis Globais                                                                            *
//                                                                                                                *
//                                                                                                                *
//*****************************************************************************************************************
//
public class VG {
	...
	// String para o Nome do Arquivo de Eventos Texto
	//static String NomeArquivoTxt = "";
	...
	static byte[] receiveData2 = new byte[128];
	...
	// Estados e Medidas de Água Quente
	static int	EstUTRAQ;
	static int	EstadoBombaAQ;
	static int	EstadoAquecedor;
	static int	TemperaturaBoiler;
	static int	TemperaturaPlaca;
	static int	TempoBmbLigada;
	static int	TempoBmbDesligada;

	// Medidas Água
	static int TmpBmbLig;
	static int TmpCxAzNvBx;
	
	// Estados e Medidas do Concentrador de Utilidades
	static int	EstConcUtil;
